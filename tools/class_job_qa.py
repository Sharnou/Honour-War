...
pet_names={"Warrior":"Ironclad Wolf","Mage":"Astral Owl","Archer":"Sky Hawk","Thief":"Moon Fox","Acolyte":"Sacred Lamb","Merchant":"Copper Badger","Ranger":"Verdant Lynx"}
for cls in expected:
    if not all(t.get("pet_affinity",{}).get("pet")==pet_names[cls] for t in d["classes"][cls]["tiers"]): raise SystemExit(f"CLASS_JOB_QA_FAIL: canonical pet affinity {cls}")
