...
unity=root/"Unity"
assert (unity/"ProjectSettings/ProjectVersion.txt").read_text().strip()=="m_EditorVersion: 6000.0.71f1"
...
print(f"UNITY_MIGRATION_PASS scripts={len(scripts)} engine=6000.0.71f1")
