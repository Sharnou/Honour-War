...
if not all(x in hud_cpp for x in ["CreateWarriorCharacter","CreateMageCharacter","CreateArcherCharacter","CreateThiefCharacter","CreateAcolyteCharacter","CreateMerchantCharacter","CreateRangerCharacter"]): raise SystemExit("CONTENT_CATALOG_FAIL: seven-class character creation UI")
