...
The runtime test script refuses to build with a different Unity Editor. A future engine migration requires an explicit project-engine migration decision rather than an automatic version change.
