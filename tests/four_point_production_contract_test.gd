...
func _run() -> void:
    ...
    _check("teleport world registry has towns fields dungeons", FileAccess.get_file_as_string("res://scripts/TeleportSystem.gd").contains(""type":"town"") and FileAccess.get_file_as_string("res://scripts/TeleportSystem.gd").contains(""type":"field"") and FileAccess.get_file_as_string("res://scripts/TeleportSystem.gd").contains(""type":"dungeon""))
    ...
    _check("fast auth remains foreground-safe", FileAccess.get_file_as_string("res://tests/fast_account_auth_test.gd").contains("call_deferred("_run_suite")") and FileAccess.get_file_as_string("res://tests/fast_account_auth_test.gd").contains("quit(0 if failures == 0 else 1)"))
