...
func _initialize() -> void:
    ...
    check("fixed MMORPG town", CITY.BUILDINGS.is_empty())
    ...
    check("Q/E yaw", camera.contains("KEY_Q") and camera.contains("KEY_E"))
    check("WASD movement", camera.contains("move_right") and camera.contains("move_left") and camera.contains("move_up") and camera.contains("move_down"))
