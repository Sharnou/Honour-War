...
static func effect_text(hero:Dictionary,skill_id:String)->String:
	...
	match skill_id:
		...
		"mage_frost_prison": return "Target is slowed by the frost field."
		"thief_smoke": return "Hero gains a short evasion window."
		"aco_sanctuary", "aco_seraphic_light", "aco_heaven_gate": return "Holy recovery effect restores the hero."
