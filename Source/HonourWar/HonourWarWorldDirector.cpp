...
void AHonourWarWorldDirector::SpawnMonsters(){MonsterSlots.Reset();const FVector Locations[]={FVector(9200,9200,120),FVector(-9200,9200,120),FVector(9200,-9200,120),FVector(-9200,-9200,120),FVector(12000,0,120),FVector(-12000,0,120)};for(int32 I=0;I<UE_ARRAY_COUNT(Locations);++I){FMonsterSlot& Slot=MonsterSlots.AddDefaulted_GetRef();Slot.Location=Locations[I];if(FVector2D(Slot.Location.X,Slot.Location.Y).Size()<7800.0f){MonsterSlots.RemoveAt(MonsterSlots.Num()-1);continue;}Slot.Level=FMath::Clamp(20+I*20,1,300);Slot.Species=EHonourWarMonsterSpecies::Goblin;Slot.RespawnTimer=0.0f;}}
